...
/* supply define */
#define SUPPLY_DET_PIN		GPIO_Pin_3
#define SUPPLY_PIN			GPIO_Pin_1

#define SUPPLY_EXIT_SOURCE	EXTI_PinSource3
#define SUPPLY_EXTI_LINE	EXTI_Line3
#define SUPPLY_EXTI_RANGE	EXTI_RANGE_2_3

#define SUPPLY_FUNC_MODE	SUPPLY_MODE_BUTTON
